...
public class EffProxyPlayerKick extends Effect {
    ...
    static {
        Skript.registerEffect(EffProxyPlayerKick.class, "[(proxy|bungeecord|bungee|velocity)] kick %-proxyplayers% [(by reason of|because [of]|on account of|due to|with [reason]) %-string%]");
    }
