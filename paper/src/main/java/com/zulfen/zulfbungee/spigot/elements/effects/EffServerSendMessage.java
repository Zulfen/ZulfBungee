...
public class EffServerSendMessage extends Effect {
    ...
    static {
        Skript.registerEffect(EffServerSendMessage.class, "(send|message|write) [a] [message] [to] %proxyservers% [(the message|[with] [the] data)] %objects% (named|called|[with] title[d]) %string%");
    }
