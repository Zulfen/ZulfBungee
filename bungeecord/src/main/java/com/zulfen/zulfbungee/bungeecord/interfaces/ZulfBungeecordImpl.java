...
public class ZulfBungeecordImpl implements ZulfProxyImpl<ProxyServer, ProxiedPlayer, Configuration> {
    ...
    @Override
    public Optional<ZulfProxyPlayer<ProxyServer, ProxiedPlayer, Configuration>> getPlayer(String nameIn) {
        ProxiedPlayer player = proxy.getPlayer(nameIn);
        return playerConverter.apply(player);
    }

    @Override
    public Optional<ZulfProxyPlayer<ProxyServer, ProxiedPlayer, Configuration>> getPlayer(UUID uuidIn) {
        ProxiedPlayer player = proxy.getPlayer(uuidIn);
        return playerConverter.apply(player);
    }

    @Override
    public List<ZulfProxyPlayer<ProxyServer, ProxiedPlayer, Configuration>> getAllPlayers() {
    ...
    @Override
    public Optional<ZulfProxyServer<ProxyServer, ProxiedPlayer, Configuration>> getServer(String serverNameIn) {
    ...
    @Override
    public NativePlayerConverter<ProxyServer, ProxiedPlayer, Configuration> getPlayerConverter() {
        return playerConverter;
    }

    @Override
    public Map<String, ZulfProxyServer<ProxyServer, ProxiedPlayer, Configuration>> getServersCopy() {

        HashMap<String, ZulfProxyServer<ProxyServer, ProxiedPlayer, Configuration>>
    ...
    @Override
    public void broadcast(String messageIn, ZulfProxyServer<ProxyServer, ProxiedPlayer, Configuration> serverIn) {
