...
public class BungeePlayer extends ZulfProxyPlayer<ProxyServer, ProxiedPlayer, Configuration> {
    ...
    @Override
    public void connect(ZulfProxyServer<ProxyServer, ProxiedPlayer, Configuration> serverIn) {
