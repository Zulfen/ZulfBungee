...
public class VelocityPlayer extends ZulfProxyPlayer<ProxyServer, Player, ConfigurationNode> {
    ...
    public VelocityPlayer(Player velocityPlayerIn, ZulfProxyServer<ProxyServer, Player, ConfigurationNode> serverIn, ZulfVelocityImpl pluginIn) {
    ...
    @Override
    public void connect(ZulfProxyServer<ProxyServer, Player, ConfigurationNode> serverIn) {
