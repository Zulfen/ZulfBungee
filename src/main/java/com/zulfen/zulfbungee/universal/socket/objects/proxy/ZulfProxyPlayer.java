...
public abstract class ZulfProxyPlayer<P, T, C> implements ProxyCommandSender {
    ...
    private final ZulfProxyServer<P, T, C> server;
    private final InetSocketAddress address;

    protected ZulfProxyPlayer(P platformIn, String nameIn, UUID uuidIn, InetSocketAddress addressIn, ZulfProxyServer<P, T, C> serverIn) {
    ...
    public ZulfProxyServer<P, T, C> getServer() {
        return server;
    }
    ...
    public abstract void connect(ZulfProxyServer<P, T, C> serverIn);
