...
public class EffServerSendMessage extends Effect {
    ...
    static {
        Skript.registerEffect(EffServerSendMessage.class, "[(proxy|bungeecord|bungee|velocity)] message [(proxy|bungeecord|bungee|velocity)] %-proxyservers% [the message] %string% (named|called|[with] title[d]) %string%");
    }
