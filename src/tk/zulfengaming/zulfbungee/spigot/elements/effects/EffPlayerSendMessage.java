...
public class EffPlayerSendMessage extends Effect {
    ...
    static {
        Skript.registerEffect(EffPlayerSendMessage.class, "[(proxy|bungeecord|bungee|velocity)] (message|send|tell) [(proxy|bungeecord|bungee|velocity)] %-proxyplayers% [the message] %string%");
    }
