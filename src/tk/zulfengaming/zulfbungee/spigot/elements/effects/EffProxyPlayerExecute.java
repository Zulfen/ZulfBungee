...
public class EffProxyPlayerExecute extends Effect {
    ...
    protected void execute(@NotNull Event event) {
        ...
        if (commandExpression != null) {
            ...
            ZulfBungeeSpigot.getPlugin().getConnectionManager().sendDirect(new Packet(PacketTypes.EXECUTE_COMMAND, true, true,
                    new PlayerCommand(players.getArray(event), commandString)));
