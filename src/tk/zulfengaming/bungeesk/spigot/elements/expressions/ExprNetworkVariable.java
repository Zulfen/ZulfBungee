    ...
    protected Object[] get(Event event) {
        ...
        try {
            ...
            if (response.isPresent()) {
                ...
                // TODO: Assumes there is more than one NetworkVariable sent in the packet. Wrong.
                return Stream.of(packetIn.getDataArray())
                        .filter(NetworkVariable.class::isInstance)
                        .map(NetworkVariable.class::cast)
                        .flatMap(networkVariable1 -> Arrays.stream(networkVariable1.getValueArray()))
