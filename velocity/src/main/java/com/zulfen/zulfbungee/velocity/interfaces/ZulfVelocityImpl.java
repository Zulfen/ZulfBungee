...
import com.zulfen.zulfbungee.core.interfaces.NativePlayerConverter;
import com.zulfen.zulfbungee.core.managers.ProxyTaskManager;
...
public class ZulfVelocityImpl implements ZulfProxyImpl<ProxyServer, Player, ConfigurationNode> {

    // TODO: i hate this
    private final NativePlayerConverter<ProxyServer, Player, ConfigurationNode> playerConverter = new NativePlayerConverter<>() {
        @Override
        public Optional<ZulfProxyPlayer<ProxyServer, Player, ConfigurationNode>> apply(Player nativePlayer) {
    ...
    @Override
    public ProxyConfig<ProxyServer, Player, ConfigurationNode> getConfig() {
        return config;
    }

    @Override
    public Optional<ZulfProxyPlayer<ProxyServer, Player, ConfigurationNode>> getPlayer(String nameIn) {
        Optional<Player> velocityPlayerOptional = velocity.getPlayer(nameIn);
        return velocityPlayerOptional.flatMap(playerConverter);
    }

    @Override
    public Optional<ZulfProxyPlayer<ProxyServer, Player, ConfigurationNode>> getPlayer(UUID uuidIn) {
    ...
    @Override
    public Optional<ZulfProxyServer<ProxyServer, Player, ConfigurationNode>> getServer(String serverNameIn) {
    ...
    @Override
    public NativePlayerConverter<ProxyServer, Player, ConfigurationNode> getPlayerConverter() {
    ...
    @Override
    public void broadcast(String messageIn, ZulfProxyServer<ProxyServer, Player, ConfigurationNode> serverIn) {
