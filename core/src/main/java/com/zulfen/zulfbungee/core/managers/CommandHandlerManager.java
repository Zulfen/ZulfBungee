...
import com.zulfen.zulfbungee.core.command.subcommands.Servers;
import com.zulfen.zulfbungee.core.command.subcommands.script.ScriptList;
import com.zulfen.zulfbungee.core.command.subcommands.script.ScriptLoad;
import com.zulfen.zulfbungee.core.command.subcommands.script.ScriptReload;
import com.zulfen.zulfbungee.core.command.ProxyCommandSender;
import com.zulfen.zulfbungee.core.command.subcommands.CheckUpdate;
import com.zulfen.zulfbungee.core.command.subcommands.Debug;
import com.zulfen.zulfbungee.core.command.subcommands.script.ScriptUnload;
...
public class CommandHandlerManager<P, T, C> {

    private final MainServer<P, T, C> mainServer;

    private final ArrayList<CommandHandler<P, T, C>> handlers = new ArrayList<>();

    public CommandHandlerManager(MainServer<P, T, C> mainServerIn) {
    ...
    public void addHandler(CommandHandler<P, T, C> handlerIn) {
    ...
    public void handle(ProxyCommandSender sender, String[] argsIn) {
        ...
        if (argsIn.length > 0) {
            ...
            Optional<CommandHandler<P, T, C>> handlerOptional = handlers
                    .stream()
            ...
            if (handlerOptional.isPresent()) {
                ...
                CommandHandler<P, T, C> handler = handlerOptional.get();
    ...
    public List<String> onTabComplete(ProxyCommandSender commandSender, String[] strings) {
        ...
        if (strings.length > 0) {
            ...
            if (!mainLabel.isEmpty()) {
                ...
                for (CommandHandler<P, T, C> pCommandHandler : handlers) {
