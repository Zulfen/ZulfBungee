package com.zulfen.zulfbungee.core.task.tasks;

import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.zulfen.zulfbungee.core.command.ProxyCommandSender;
import com.zulfen.zulfbungee.core.ZulfProxyImpl;
import com.zulfen.zulfbungee.core.task.tasks.util.UpdateResult;
import com.zulfen.zulfbungee.core.task.tasks.util.VersionStatus;
...
public class CheckUpdateTask<P, T, C> implements Supplier<Optional<UpdateResult>> {

    private final ZulfProxyImpl<P, T, C> pluginInstance;

    public CheckUpdateTask(ZulfProxyImpl<P, T, C> instanceIn) {
    ...
    public Optional<UpdateResult> get() {
        ...
        try (InputStream inputStream = new URI("https://api.github.com/repos/Zulfen/ZulfBungee/releases/latest").toURL().openStream(); Scanner scanner = new Scanner(inputStream)) {
            ...
            String latestVersion = jsonObject
                    .get("tag_name")
                    .getAsString();
