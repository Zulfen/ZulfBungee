...
import com.zulfen.zulfbungee.core.socket.transport.SocketServerConnection;
...
public class SocketMainServer<P, T, C> extends MainServer<P, T, C> implements Runnable {
    ...
    public SocketMainServer(int port, InetAddress address, ZulfProxyImpl<P, T, C> instanceIn, CheckUpdateTask<P, T, C> updateTaskIn) {
    ...
    private void acceptSocketConnection(Socket socketIn) throws IOException {
        SocketServerConnection<P, T, C> connection = new SocketServerConnection<>(this, socketIn);
