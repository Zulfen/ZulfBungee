...
public class ProxySocketCommHandler<P, T, C> extends ProxyCommHandler<P, T, C> {

    private final SocketServerConnection<P, T, C> connection;
    private final Socket socket;

    private final ObjectOutputStream outputStream;
    private final ObjectInputStream inputStream;

    public ProxySocketCommHandler(SocketServerConnection<P, T, C> connectionIn, Socket socketIn) throws IOException {
        super(connectionIn);
