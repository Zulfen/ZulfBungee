package com.zulfen.zulfbungee.core.storage.db;

import com.zaxxer.hikari.HikariDataSource;
import com.zulfen.zulfbungee.core.managers.MainServer;
import com.zulfen.zulfbungee.core.storage.HikariSQLImpl;

public class MySQLImpl<P, T, C> extends HikariSQLImpl<P, T, C> {

    public MySQLImpl(MainServer<P, T, C> mainServerIn) {
        super(mainServerIn);
    }
