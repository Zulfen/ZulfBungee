...
import com.zulfen.zulfbungee.core.command.util.CommandUtils;
...
public class ScriptReload<P, T, C> extends CommandHandler<P, T, C> {

    private final WatchKey watchKey;
    private final Path scriptsFolderPath;

    public ScriptReload(MainServer<P, T, C> mainServerIn) {
